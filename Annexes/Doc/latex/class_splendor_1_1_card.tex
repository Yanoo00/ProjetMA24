\section{Splendor.\+Card Class Reference}
\label{class_splendor_1_1_card}\index{Splendor.\+Card@{Splendor.\+Card}}


class \doxyref{Card}{p.}{class_splendor_1_1_card} \+: attributes and methods to deal with a card  
...
\begin{DoxyCompactItemize}
\item 
Ressources \textbf{ Ress}\hspace{0.3cm}{\ttfamily  [get, set]}
\begin{DoxyCompactList}\small\item\em the precious stone that the card gives \end{DoxyCompactList}\item 
int \textbf{ Prestige\+Pt}\hspace{0.3cm}{\ttfamily  [get, set]}
...
int [$\,$] \textbf{ Cout}\hspace{0.3cm}{\ttfamily  [get, set]}
...
\subsubsection{Cout}
{\footnotesize\ttfamily int [$\,$] Splendor.\+Card.\+Cout\hspace{0.3cm}{\ttfamily [get]}, {\ttfamily [set]}}
...
\item 
C\+:/\+Users/\+Brian.\+R\+O\+D\+R\+I\+G\+U\+E\+S-\/\+F\+R\+A\+G/\+One\+Drive -\/ C\+P\+N\+V/\+Git\+Hub/\+Projet\+M\+A24/\+Splendor/Card.\+cs\end{DoxyCompactItemize}
